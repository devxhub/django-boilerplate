...
from {{ devxhub_python.project_slug }}.users.api.inputs import *
from {{ devxhub_python.project_slug }}.users.api.schema import UserObjectType
{%- if devxhub_python.use_celery == 'y' %}
from {{ devxhub_python.project_slug }}.users.tasks import *
{%- endif %}
{%- if devxhub_python.use_celery == 'n' %}
