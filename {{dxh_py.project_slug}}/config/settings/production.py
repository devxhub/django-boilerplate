...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["{{ dxh_py.domain_name }}"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="{{dxh_py.project_name}} <noreply@{{dxh_py.domain_name}}>",
)
...
SPECTACULAR_SETTINGS["SERVERS"] = [  # noqa: F405
    {"url": "https://{{ dxh_py.domain_name }}", "description": "Production server"},
]
